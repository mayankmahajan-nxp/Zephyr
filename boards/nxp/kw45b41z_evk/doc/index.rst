...
The KW45B41Z-EVK is a development kit enabled by the Kinetis |reg| W series
...
The KW45B41Z-EVK kit contains two Freedom boards that can be used as a
development board or a shield to connect to a host processor. The KW45B41Z-EVK is
form-factor compatible with the Arduino |trade| R3 pin layout for more expansion
options.

The KW45B41Z-EVK highly-sensitive, optimized 2.4 GHz radio features a PCB
...
For more information about the KW41Z SoC and KW45B41Z-EVK board:

- `KW41Z Website`_
- `KW41Z Datasheet`_
- `KW41Z Reference Manual`_
- `KW45B41Z-EVK Website`_
- `KW45B41Z-EVK User Guide`_
- `KW45B41Z-EVK Schematics`_
...
currently enabled (PORTA/GPIOA and PORTC/GPIOC) for the KW45B41Z-EVK board.
...
the `OpenSDA DAPLink KW45B41Z-EVK Firmware`_.
...
the `OpenSDA J-Link KW45B41Z-EVK Firmware`_.
...
.. _FRDM-KW41Z Website:
   https://www.nxp.com/products/processors-and-microcontrollers/arm-based-processors-and-mcus/kinetis-cortex-m-mcus/w-serieswireless-conn.m0-plus-m4/freedom-development-kit-for-kinetis-kw41z-31z-21z-mcus:KW45B41Z-EVK

.. _FRDM-KW41Z User Guide:
   https://www.nxp.com/webapp/Download?colCode=FRDMKW41ZUG

.. _FRDM-KW41Z Schematics:
   https://www.nxp.com/webapp/Download?colCode=KW45B41Z-EVK-SCH
