...
#define UBX_CFG_PRT_DATA_RESERVED0			0x00
...
#define UBX_CFG_PRT_DATA_RESERVED1			0x00
#define UBX_CFG_PRT_DATA_FLAGS_DEFAULT			0x0000
#define UBX_CFG_PRT_DATA_FLAGS_EXTENDED_TX_TIMEOUT	BIT(0)
...
#define UBX_CFG_RST_DATA_RESERVED0		0x00
...
#define UBX_CFG_NAV5_DATA_MASK_ALL			0x05FF
#define UBX_CFG_NAV5_DATA_FIX_MODE_DEFAULT		UBX_FIX_AUTO_FIX
#define UBX_CFG_NAV5_DATA_FIXED_ALT_DEFAULT		0
#define UBX_CFG_NAV5_DATA_FIXED_ALT_VAR_DEFAULT		1U
#define UBX_CFG_NAV5_DATA_MIN_ELEV_DEFAULT		5
#define UBX_CFG_NAV5_DATA_DR_LIMIT_DEFAULT		3U
#define UBX_CFG_NAV5_DATA_P_DOP_DEFAULT			100U
#define UBX_CFG_NAV5_DATA_T_DOP_DEFAULT			100U
#define UBX_CFG_NAV5_DATA_P_ACC_DEFAULT			100U
#define UBX_CFG_NAV5_DATA_T_ACC_DEFAULT			350U
#define UBX_CFG_NAV5_DATA_STATIC_HOLD_THRESHOLD_DEFAULT	0U
#define UBX_CFG_NAV5_DATA_DGNSS_TIMEOUT_DEFAULT		60U
#define UBX_CFG_NAV5_DATA_CNO_THRESHOLD_NUM_SVS_DEFAULT	0U
#define UBX_CFG_NAV5_DATA_CNO_THRESHOLD_DEFAULT		0U
#define UBX_CFG_NAV5_DATA_RESERVED0			0U
#define UBX_CFG_NAV5_DATA_STATIC_HOLD_DIST_THRESHOLD	0U
#define UBX_CFG_NAV5_DATA_UTC_STANDARD_DEFAULT		UBX_UTC_AutoUTC
...
#define U_BLOX_CFG_GNSS_MSG_VER			0x00
#define U_BLOX_CFG_GNSS_NUM_TRK_CH_HW_DEFAULT		0x31
#define U_BLOX_CFG_GNSS_NUM_TRK_CH_USE_DEFAULT		0x31

#define U_BLOX_CFG_GNSS_RESERVED0			0x00
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_ENABLE			BIT(0)
#define UBX_CFG_GNSS_SGN_CNF_SHIFT				16
/* When gnssId is 0 (GPS) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_GPS_L1C_A	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_GPS_L2C	0x10 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_GPS_L5	0x20 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 1 (SBAS) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_SBAS_L1C_A	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 2 (Galileo) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_Galileo_E1	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_Galileo_E5A	0x10 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_Galileo_E5B	0x20 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 3 (BeiDou) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_BeiDou_B1I	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_BeiDou_B2I	0x10 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_BeiDou_B2A	0x80 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 4 (IMES) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_IMES_L1	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 5 (QZSS) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_QZSS_L1C_A	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_QZSS_L1S	0x04 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_QZSS_L2C	0x10 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_QZSS_L5	0x20 << UBX_CFG_GNSS_SGN_CNF_SHIFT
/* When gnssId is 6 (GLONASS) */
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_GLONASS_L1	0x01 << UBX_CFG_GNSS_SGN_CNF_SHIFT
#define U_BLOX_CFG_GNSS_CNF_BLK_FLAG_SGN_CNF_MASK_GLONASS_L2	0x10 << UBX_CFG_GNSS_SGN_CNF_SHIFT
