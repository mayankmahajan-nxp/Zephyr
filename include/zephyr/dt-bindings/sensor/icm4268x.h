 ...
 * @{
 */
#define ICM4268X_DT_ACCEL_FS_16		0
#define ICM4268X_DT_ACCEL_FS_8		1
#define ICM4268X_DT_ACCEL_FS_4		2
#define ICM4268X_DT_ACCEL_FS_2		3
/** @} */
 ...
 * @{
 */
#define ICM4268X_DT_GYRO_FS_2000	0
#define ICM4268X_DT_GYRO_FS_1000	1
#define ICM4268X_DT_GYRO_FS_500		2
#define ICM4268X_DT_GYRO_FS_250		3
#define ICM4268X_DT_GYRO_FS_125		4
#define ICM4268X_DT_GYRO_FS_62_5	5
#define ICM4268X_DT_GYRO_FS_31_25	6
#define ICM4268X_DT_GYRO_FS_15_625	7
/** @} */
