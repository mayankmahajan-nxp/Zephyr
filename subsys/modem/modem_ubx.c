			   ...
			   uint8_t msg_id, const void *payload, uint16_t payload_size)
{
	...
	ubx_frame_t *frame = (ubx_frame_t *) ubx_frame;
...
static int modem_ubx_get_payload_length(ubx_frame_t *frame)
{
...
static int modem_ubx_get_frame_length(ubx_frame_t *frame)
{
	return modem_ubx_get_payload_length(frame) + UBX_FRM_SZ_WITHOUT_PAYLOAD;
}

static bool modem_ubx_match_frame_type(ubx_frame_t *frame_1, ubx_frame_t *frame_2)
{
...
static bool modem_ubx_match_frame_full(ubx_frame_t *frame_1, ubx_frame_t *frame_2)
{
...
{
	int ret;
	ubx_frame_t *received = (ubx_frame_t *) ubx->work_buf;
